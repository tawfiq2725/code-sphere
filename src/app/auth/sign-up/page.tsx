...
// Dynamically import the OTP component with a loading fallback
const OtpPage = dynamic(() => import("@/app/components/common/Otp"), {
...
export default function SignupPage() {
  ...
  // Preload the OTP component on mount
  useEffect(() => {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store the email for OTP verification and reset the form
  ...
  // Render OTP component if we are in the OTP step
  if (isOtpStep) {
    return <OtpPage userEmail={userEmail} />;
  }
